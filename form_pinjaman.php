    ...
    <main class="d-flex flex-nowrap">
      ...
      <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="form_pinjaman.php" class="nav-link active text-white">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form method="post" id="myFormModal" action="" class="container">
		  <div class="row">
		    <div class="col-md-12 mb-3">
        <label for="jenisModal">Nama:</label>
			<input type="text" class="form-control" id="jenisModal" name="jenis">
		      
		    </div>
			<label for="nilaiModal" class="form-label">Jumlah:</label>
			<div class="col-md-12 input-group mb-3">
  			<div class="input-group-prepend">
   			 <span class="input-group-text" id="inputGroup-sizing-default">Rp</span>
  				</div>
		    ...
		    <div class="col-md-12 mb-3">
        <label for="tanggalModal">Jatuh Tempo:</label>
			<input type="date" class="form-control" id="tanggalModal" name="tanggal">
		    </div>
		  </div>
      </div>
      <div class="modal-footer">
...
<script src="js/create_pinjaman.js"></script>
<script src="js/read_pinjaman.js"></script>
<script src="js/update_pinjaman.js"></script>
<script src="js/delete_pinjaman.js"></script>
</script>
