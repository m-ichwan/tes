    ...
    <main class="d-flex flex-nowrap">
      ...
      <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="form.php" class="nav-link  text-white">
      ...
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card bg-primary text-white">
          <div class="card-body">
            ...
            <p id="totaluang" class="card-text"></p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card bg-success text-white">
          <div class="card-body">
            ...
            <p id="totalPemasukan" class="card-text"></p>
          </div>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 mb-4">
        <div class="card bg-danger text-white">
          <div class="card-body">
            ...
            <p id="totalPengeluaran" class="card-text"></p>
          </div>
        </div>
      </div>
    </div>
  </div>
  <div class="chartjs" style="width: 500px;"><canvas id="chartjs"></canvas></div>

  <script>
    const userId = document.getElementById('user-id').value;
  (() => {
  fetch(`api/index.php?user=${userId}`)
    ...
    .then(data => {
      ...
      data.data.forEach(item => {
        if (item.jenis === 'Pemasukan') {
          totalPemasukan += parseInt(item.nilai);
        } else {
          totalPengeluaran += parseInt(item.nilai);
        }
      });

      // Menghitung total keuangan
      let totalKeuangan = totalPemasukan - totalPengeluaran;
// console.log(totalPemasukan)
// console.log(totalPengeluaran)
// console.log(totalKeuangan)
      // Memperbarui isi dari elemen HTML
      document.getElementById('totaluang').innerHTML = 'Rp ' + totalKeuangan.toLocaleString();
      document.getElementById('totalPemasukan').innerHTML = 'Rp ' + totalPemasukan.toLocaleString();
      document.getElementById('totalPengeluaran').innerHTML = 'Rp ' + totalPengeluaran.toLocaleString();
    })
    .catch(error => console.error(error));
})();

// chartjs
function drawChart(pemasukan, pengeluaran) {
    ...
    const chartContainer = document.getElementById('chartjs');
  ...
  function fetchAndDrawChart() {
    fetch(`api/index.php?user=${userId}`)
      ...
      .then(data => {
        ...
        drawChart(totalPemasukan, totalPengeluaran);

        // Fetch data lagi setelah 1 detik
        setTimeout(fetchAndDrawChart, 1000);
      })
      .catch(error => console.error(error));
  }

  // Mulai menggambar chart setelah halaman selesai dimuat
  window.addEventListener('load', fetchAndDrawChart);
  </script>
