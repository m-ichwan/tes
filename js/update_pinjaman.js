...
function saveData() {
  ...
  const tanggalModal = document.getElementById("tanggalModal").value;
  ...
  console.log("Jatuh Tempo: " + tanggalModal);
  ...
  formData.append("tanggal", tanggalModal);

  // Lakukan pengiriman data ke server menggunakan fetch()
  fetch("api/update_pinjaman.php", {
    method: "POST",
    body: formData,
  })
